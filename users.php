    ...
    <div class="flex h-screen">
        ...
        <aside class="w-64 bg-gradient-to-b from-gray-900 to-gray-800 text-white flex flex-col">
            ...
            <nav class="flex-1 p-4 space-y-2">
                ...
                <a href="users.php" class="flex items-center gap-3 p-3 rounded-lg bg-blue-600 text-white">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-6">
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden">
                        <table class="w-full">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold text-lg mr-3">
                                                A
                                            </div>
                                            <div>
                                                <div class="font-medium text-gray-900">Admin Principal</div>
                                                <div class="text-sm text-gray-500">admin@blogcms.com</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4">
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="w-12 h-12 bg-gradient-to-br from-green-500 to-teal-500 rounded-full flex items-center justify-center text-white font-bold text-lg mr-3">
                                                F
                                            </div>
                                            <div>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="w-12 h-12 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-full flex items-center justify-center text-white font-bold text-lg mr-3">
                                                K
                                            </div>
                                            <div>
                                                <div class="font-medium text-gray-900">Karim Benjelloun</div>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4">
                                        <div class="flex items-center">
                                            <div class="w-12 h-12 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center text-white font-bold text-lg mr-3">
                                                S
                                            </div>
                                            <div>
                                                <div class="font-medium text-gray-900">Sara Alami</div>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex items-center gap-2">
                                            <button class="text-blue-600 hover:text-blue-900">Éditer</button>
                                            <button class="text-yellow-600 hover:text-yellow-900">Promouvoir</button>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <div class="flex items-center justify-between border-t border-gray-200 px-6 py-4">
                            <div class="text-sm text-gray-700">
                                Affichage de <span class="font-medium">1</span> à <span class="font-medium">4</span> sur <span class="font-medium">23</span> utilisateurs
                            </div>
                            <div class="flex items-center gap-2">
                    ...
                    <!-- Create User Form -->
                    <div class="bg-white rounded-xl shadow-md p-6">
                        <h3 class="text-lg font-bold text-gray-800 mb-4">Ajouter un nouvel utilisateur</h3>
